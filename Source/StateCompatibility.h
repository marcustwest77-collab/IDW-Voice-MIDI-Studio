...
inline juce::ValueTree withV5Defaults(juce::ValueTree tree,juce::AudioProcessorValueTreeState& state){
    for(const char* id:{"harmonyMode","harmonyVoicing","harmonyBass","voiceLow","voiceHigh","synthEnabled","synthLead","synthChord","synthBass","synthGain","synthTone","synthAttack","synthRelease","synthDelay"}){

...
void IDWVoiceMIDIStudioAudioProcessorEditor::paint(juce::Graphics& g){
    ...
    if(performanceView){
        ...
        g.setColour(gold);g.setFont(juce::FontOptions(12,juce::Font::bold));g.drawText("V6.7",getWidth()-355,22,330,30,juce::Justification::centredRight);
    ...
    g.setColour(gold);g.setFont(juce::FontOptions(12,juce::Font::bold));g.drawText("V6.7",getWidth()-335,22,310,30,juce::Justification::centredRight);
...
juce::String IDWVoiceMIDIStudioAudioProcessorEditor::diagnosticReport() const {
    juce::String text="IDW Voice MIDI Studio 6.7.0 setup report\n";
...
juce::String IDWVoiceMIDIStudioAudioProcessorEditor::manualText(){return R"HELP(IDW VOICE MIDI STUDIO / VERSION 6.7
